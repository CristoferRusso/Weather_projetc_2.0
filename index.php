    ...
    <div class="container">
        <form style="width: 60%; margin:auto;">
            ...
            <form action="index.php">
                <div class="mb-3">
                    <input class="form-control" id="city" name="city" value="<?= $city ?>" placeholder="Enter your city here" style="background-color: rgba(255, 255, 255, 0.6)">
                </div>
            ...
            <div class="container" style='padding-top:30%; width: auto;'>With API from OpenWeatherMap </div>
        </form>
    </div>
    <div id="map"></div>
